...
#--------------------------------------------------------------------------------------------------
    ...
    def render(self, virtual_screen, dt=0.0):
        ...
        #draw_text('Let\'s play', self.flappyFont, VIRTUAL_WIDTH / 2, 64, (255, 255, 255), virtual_screen)
        #draw_text('counting down', self.mediumFont, VIRTUAL_WIDTH / 2, 100, (255, 255, 255), virtual_screen)
        #print("PlayState: render")
