...
# This dictionary will hold all loaded game assets
assets = {}
...
def load():
    ...
    global window, virtual_screen, clock, stateManager, music, assets
    ...
    # Set window title
    pygame.display.set_caption('FC Breakout')
    ...
    assets['fonts']['small'] = pygame.font.Font('assets/fonts/font.ttf', 8)
    # Load Large font for the loading screen
    assets['fonts']['large'] = pygame.font.Font('assets/fonts/font.ttf', 32)

    assets['sounds'] = {}
    # Load the game music
    assets['sounds']['music'] = pygame.mixer.music.load('assets/sounds/music.wav')
...
def init():
    ...
    stateManager.changeState(LoadState(assets))

#---------------------------------------------------------

def render(dt):
    global virtual_screen, assets
    ...
    display_fps(virtual_screen, assets['fonts']['small'], int(clock.get_fps()))
