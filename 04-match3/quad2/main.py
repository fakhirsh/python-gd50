...
def load():
    ...
    global window, virtual_screen, clock, matchImg, quads
...
#---------------------------------------------------------
    ...
    print(len(quads))
    print(matchImg.get_width(), matchImg.get_height())
...
def render(dt):
    ...
    virtual_screen.blit(matchImg, (0,0), quads[random.randint(0, len(quads)-1)])
