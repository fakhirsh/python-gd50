...
def load():
    ...
    global window, virtual_screen, clock, matchImg, quad
...
def render(dt):
    global quad, matchImg, timer

    # Clear the screen with a specific color
    virtual_screen.fill((0, 0, 0))

    #virtual_screen.blit(matchImg, (0, 0))
    virtual_screen.blit(matchImg, (0,0), quad)
