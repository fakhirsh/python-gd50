...
class TweenManager:
    ...
    def create_tween(obj, property_name, start_val, end_val, duration, easing_func, on_complete=None):
        """Create and add a tween to the manager."""
        tween = Tween(obj, property_name, start_val, end_val, duration, easing_func, on_complete)
